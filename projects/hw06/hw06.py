...
class VendingMachine:
    ...
    def vend(self):
        if self.inv == 0:
            ...
            if self.fund < self.price:
                ...
                if self.fund > self.price:
                    print(f"'Here is your {self.name} and ${self.fund - self.price} change.'")
                    self.fund = 0
                    self.inv -= 1
                else:
    ...
    def restock(self, inv):
        self.inv += inv
        print(f"'Current {self.name} stock: {self.inv}'")
...
def store_digits(n):
    ...
    if n // 10 == 0:
        ...
        power = len(repr(n))
        return Link(n // (10 ** (power - 1)), store_digits(n % (10 ** (power - 1))))
...
def two_list(vals, counts):
    ...
    """
    "*** YOUR CODE HERE ***"
    if counts[0] == 1 and len(counts) == 1:
        return Link(vals[0])
    elif counts[0] == 1:
        ...
        new_counts = counts
        new_counts[0] -= 1
        return Link(vals[0], two_list(vals, new_counts))
